...
<ListGroup>
  ...
  <ListGroupItem header="Heading 3" variant="danger">
    Danger styling
  </ListGroupItem>
</ListGroup>
```
...
| 参数           | 类型                | 默认值       | 说明         |
| -------------- | ------------------- | ------------ | ------------ |
| as | elementType(li div) |              | 组件元素类型 |
| bsPrefix        | string              | 'list-group' | 扩展类       |
...
| href     | string     | null              | 链接           |
| type     | string     | null              | 类型           |
| variant  | string     | null              | 颜色           |
| bsPrefix  | string     | 'list-group-item' | 扩展类         |
