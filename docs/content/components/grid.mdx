...
| 参数    | 类型                      | 默认值 | 说明     |
| ------- | ------------------------- | ------ | -------- |
| as | elementType | 'div' | 使用一个此组件提供的定制化样式。 |
...
| bsPrefix | string | 'col' | 定义组件基础 CSS 及前缀。通常改变 bsPrefix 目的是为组件提供新的、非 Bootstrap 自带样式。 |

### Row
| 参数    | 类型                      | 默认值 | 说明     |
| ------- | ------------------------- | ------ | -------- |
| as | elementType | 'div' | 使用一个此组件提供的定制化样式。 |
| bsPrefix | string | 'row' | 定义组件基础 CSS 及前缀。通常改变 bsPrefix 目的是为组件提供新的、非 Bootstrap 自带样式。 |